from core.models import (Address, Membership, NodeInstallation, Organization,
                         Site)
...
class NodeInstallationSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('site', 'node', 'from_timestamp',
                  'to_timestamp', 'description', 'url')
...
class MembershipSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Membership
        fields = ('organization', 'user', 'user_id', 'user_name',
                  'organization_id', 'organization_name', 'role', 'url')
